...
def subscribe_callback(data: Imu):
    ...
    # angular velocity
    imu_out.angular_velocity.x =  data.angular_velocity.x
    imu_out.angular_velocity.y =  data.angular_velocity.y
    imu_out.angular_velocity.z = -data.angular_velocity.z

    for index in imu_out.angular_velocity_covariance:
        index = 0

    # linear acceleration
    imu_out.linear_acceleration.x = -data.linear_acceleration.x
    imu_out.linear_acceleration.y = -data.linear_acceleration.y
    imu_out.linear_acceleration.z =  data.linear_acceleration.z
